...
export class ScheduleRiskController {
   ...
   */
  @Post('evaluate')
  // First-party feature called by the web and mobile apps with the user's
  // session, so it takes the Supabase JWT guard rather than the API-user key —
  // matching tournaments' `evaluate-fit`.
