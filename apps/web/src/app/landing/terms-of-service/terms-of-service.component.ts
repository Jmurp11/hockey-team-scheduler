      ...
      <p-card styleClass="terms-card">
        <ng-template pTemplate="content">
          <div class="terms-content">
            ...
            <p class="updated-date">Updated at 2026-01-23</p>

            <section>
              <h2>General Terms</h2>
              <p>
                By accessing and placing an order with RinkLink.ai, you confirm
                ...
                communication between you and RinkLink.ai.
              </p>
              <p>
                Under no circumstances shall RinkLink.ai team be liable for any
                ...
                site, even if RinkLink.ai team or an authorized representative
                has been advised of the possibility of such damages. If your use
              ...
              <p>
                RinkLink.ai will not be responsible for any outcome that may
            ...
            <section>
              <h2>License</h2>
              <p>
                RinkLink.ai grants you a revocable, non-exclusive,
                non-transferable, limited license to download, install and use
                the website/app strictly in accordance with the terms of this
                Agreement.
              </p>
              <p>
                These Terms & Conditions are a contract between you and
                RinkLink.ai (referred to in these Terms & Conditions as
                "RinkLink.ai", "us", "we" or "our"), the provider of the
                RinkLink.ai website and the services accessible from the
                RinkLink.ai website (which are collectively referred to in these
                Terms & Conditions as the "RinkLink.ai Service").
              </p>
              <p>
                ...
                RinkLink.ai Service. In these Terms & Conditions, "you" refers
            ...
            <section>
              ...
              <ul>
                ...
                <li>
                  ...
                  "we," "us," or "our," it refers to RINKLINKAI LLC, 37 Greenway
                  Ln Rye Brook, NY 10573 that is responsible for your
                ...
                <li>
                  ...
                  to visit RinkLink.ai and use the services.
                </li>
                <li>
                  <strong>Service:</strong> refers to the service provided by
                  RinkLink.ai as described in the relative terms (if available)
                ...
                <li>
                  <strong>Website:</strong> RinkLink.ai's site, which can be
                  accessed via this URL: https://www.rinklink.ai
                </li>
                <li>
                  <strong>You:</strong> a person or entity that is registered
                  with RinkLink.ai to use the Services.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul>
                ...
                <li>
                  ...
                  notice of copyright or trademark) of RinkLink.ai or its
            ...
            <section>
              ...
              <p>
                Thanks for shopping at RinkLink.ai. We appreciate the fact that
              ...
              <p>
                ...
                that apply to transactions at RinkLink.ai. We'll be as brief as
                our attorneys will allow. The main thing to remember is that by
                placing an order or making a purchase at RinkLink.ai, you agree
                to the terms along with RinkLink.ai's Privacy Policy.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                ...
                (collectively, "Suggestions") provided by you to RinkLink.ai
                with respect to the website/app shall remain the sole and
                exclusive property of RinkLink.ai.
              </p>
              <p>
                RinkLink.ai shall be free to use, copy, modify, publish, or
            ...
            <section>
              ...
              <p>
                ...
                site and how it's being used. By using our website/app,
            ...
            <section>
              ...
              <p>
                ...
                controlled by RinkLink.ai. We are not responsible for the
            ...
            <section>
              <h2>Cookies</h2>
              <p>
                RinkLink.ai uses "Cookies" to identify the areas of our website
            ...
            <section>
              ...
              <p>
                You acknowledge and agree that RinkLink.ai may stop (permanently
                or temporarily) providing the Service (or any features within
                the Service) to you or to users generally at sole discretion,
                without prior notice to you. You may stop using the Service at
                any time. You do not need to specifically inform RinkLink.ai
                when you stop using the Service. You acknowledge and agree that
                if RinkLink.ai disables access to your account, you may be
            ...
            <section>
              ...
              <p>
                RinkLink.ai reserves the right to modify, suspend or
                discontinue, temporarily or permanently, the website/app or any
            ...
            <section>
              ...
              <p>
                RinkLink.ai may from time to time provide enhancements or
                improvements to the features/ functionality of the website/app,
              ...
              <p>
                ...
                functionalities of the website/app. You agree that RinkLink.ai
              ...
              <p>
                ...
                constitute an integral part of the website/app, and (ii) subject
            ...
            <section>
              ...
              <p>
                You acknowledge and agree that RinkLink.ai shall not be
                ...
                thereof. RinkLink.ai does not assume and shall not have any
            ...
            <section>
              ...
              <p>
                RinkLink.ai may, in its sole discretion, at any time and for any
              ...
              <p>
                ...
                from RinkLink.ai, in the event that you fail to comply with any
                provision of this Agreement. You may also terminate this
                Agreement by deleting the website/app and all copies thereof
                from your computer.
              </p>
              <p>
                Upon termination of this Agreement, you shall cease all use of
                the website/app and delete all copies of the website/app from
                your computer.
              </p>
              <p>
                Termination of this Agreement will not limit any of RinkLink.ai's
            ...
            <section>
              ...
              <p>
                ...
                any material on our website/app constitutes an infringement on
            ...
            <section>
              ...
              <p>
                You agree to indemnify and hold RinkLink.ai and its parents,
                ...
                your: (a) use of the website/app; (b) violation of this
            ...
            <section>
              <h2>No Warranties</h2>
              <p>
                The website/app is provided to you "AS IS" and "AS AVAILABLE"
                and with all faults and defects without warranty of any kind. To
                the maximum extent permitted under applicable law, RinkLink.ai,
                ...
                otherwise, with respect to the website/app, including all
              ...
              <p>
                Without limiting the foregoing, RinkLink.ai provides no warranty
                ...
                results, be compatible or work with any other software, systems
                or services, operate without interruption, meet any performance
                or reliability standards or be error free or that any errors or
            ...
            <section>
              ...
              <p>
                ...
                liability of RinkLink.ai and any of its suppliers under any
                ...
                you for the website/app.
              </p>
              <p>
                To the maximum extent permitted by applicable law, in no event
                shall RinkLink.ai or its suppliers be liable for any special,
                ...
                website/app, third-party software and/or third-party hardware
                used with the website/app, or otherwise in connection with any
                provision of this Agreement), even if RinkLink.ai or any
            ...
            <section>
              ...
              <p>
                ...
                legal notices published by RinkLink.ai on the Services, shall
                constitute the entire agreement between you and RinkLink.ai
            ...
            <section>
              ...
              <p>
                RinkLink.ai reserves the right, at its sole discretion, to
              ...
              <p>
                By continuing to access or use our website/app after any
                revisions become effective, you agree to be bound by the revised
                terms. If you do not agree to the new terms, you are no longer
                authorized to use RinkLink.ai.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                RinkLink.ai regarding your use of the website/app and supersedes
              ...
              <p>
                ...
                when you use or purchase other RinkLink.ai's services, which
                RinkLink.ai will provide to you at the time of such use or
                purchase.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                RinkLink.ai, its licensors or other providers of such material
                and are protected by and international copyright, trademark,
                ...
                of RinkLink.ai, unless and except as is expressly provided in
            ...
            <section>
              ...
              <p>
                ...
                REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR RinkLink.ai's
                INTELLECTUAL PROPERTY RIGHTS. The term "dispute" means any
                dispute, action, or other controversy between you and
                RinkLink.ai concerning the Services or this agreement, whether
            ...
            <section>
              ...
              <p>
                In the event of a dispute, you or RinkLink.ai must give the
            ...
            <section>
              ...
              <p>
                If you and RinkLink.ai don't resolve any dispute by informal
            ...
            <section>
              ...
              <p>
                ...
                property of RinkLink.ai without any compensation or credit to
                you whatsoever. RinkLink.ai and its affiliates shall have no
            ...
            <section>
              <h2>Promotions</h2>
              <p>
                RinkLink.ai may, from time to time, include contests,
            ...
            <section>
              ...
              <p>
                ...
                and signed by an authorized representative of RinkLink.ai.
                RinkLink.ai will be entitled to injunctive or other equitable
                relief (without the obligations of posting any bond or surety)
                in the event of any breach or anticipatory breach by you.
                RinkLink.ai operates and controls the RinkLink.ai Service from
                its offices in New York. The Service is not intended for
            ...
            <section>
              <h2>Disclaimer</h2>
              <p>RinkLink.ai is not responsible for any content, code or any other imprecision.</p>
              <p>RinkLink.ai does not provide warranties or guarantees.</p>
              <p>
                In no event shall RinkLink.ai be liable for any special, direct,
              ...
              <p>
                The RinkLink.ai Service and its contents are provided "as is"
                and "as available" without any warranty or representations of
            ...
            <section>
              ...
              <ul>
                <li>Via Email: support&#64;rinklink.ai</li>
                <li>Via this Link: <a href="/contact">https://www.rinklink.ai/contact</a></li>
              </ul>
            </section>
          </div>
        </ng-template>
...
export class TermsOfServiceComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seoService.updateTags({
      title: 'Terms of Service - RinkLink.ai',
      description:
        'Read the Terms of Service for RinkLink.ai, your AI-powered youth hockey scheduling platform.',
      url: 'https://rinklink.ai/terms-of-service',
      keywords:
        'terms of service, terms and conditions, rinklink, hockey scheduling, legal',
    });
  }
}
